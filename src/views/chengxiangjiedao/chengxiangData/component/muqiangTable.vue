          ...
          series: [
            {
              ...
              center: ['50%', '45%'],
              data: [
                { value: this.chartData[0].count, name: this.chartData[0].jianzhumuqiang },
                { value: this.chartData[1].count, name: this.chartData[1].jianzhumuqiang },
                { value: this.chartData[2].count, name: this.chartData[2].jianzhumuqiang }
              ],
